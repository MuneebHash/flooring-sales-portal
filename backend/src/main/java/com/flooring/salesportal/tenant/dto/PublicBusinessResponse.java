 ...
 * is deliberately absent from this record and is exposed only via the authenticated
 * invoice-config endpoint (Phase 15A). Global Jackson SNAKE_CASE serialises these as
